...
type Store interface {
	...
	ListNotes(ctx context.Context, repoID int64, branch string, limit int) ([]Note, error)
	AddTask(ctx context.Context, input AddTaskInput) (Task, error)
	ListTasks(ctx context.Context, repoID int64, branch string, limit int) ([]Task, error)
	...
	ListDecisions(ctx context.Context, repoID int64, branch string, limit int) ([]Decision, error)
	AddHandoff(ctx context.Context, input AddHandoffInput) (Handoff, error)
	ListHandoffs(ctx context.Context, repoID int64, branch string, limit int) ([]Handoff, error)
